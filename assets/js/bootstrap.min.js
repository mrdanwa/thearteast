...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=3f4f43abb16e658eac0c)
 * Config saved to config.json and https://gist.github.com/3f4f43abb16e658eac0c
 */
    ...
    (i.VERSION = "3.3.5"),
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (h) {
            ...
            (r =
              "bottom" == r && p.bottom + d > u.bottom
                ? "top"
                : "top" == r && p.top - d < u.top
                ? "bottom"
                : "right" == r && p.right + c > u.width
                ? "left"
                : "left" == r && p.left - c < u.left
                ? "right"
                : r),
              s.removeClass(f).addClass(r);
          }
          var g = this.getCalculatedOffset(r, p, c, d);
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        ...
        if (/right|left/.test(t)) {
          ...
          h < a.left
            ? (n.left = a.left - h)
            : p > a.right && (n.left = a.left + a.width - p);
        }
        return n;
      }),
